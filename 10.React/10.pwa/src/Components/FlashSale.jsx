...
export default function FlashSale() {
  ...
  return (
    <div className={`${darkMode ? "bg-slate-900" : ""}`}>
      <div
        className={` mx-4 md:mx-16 xl:mx-[92px] ${darkMode ? "bg-slate-900" : ""}`}
      >
        {isLoading ? "Loading..." : ""}
        {error}
        ...
        <div
          className={`bg-primary  text-white w-40 h-12 text-sm sm:text-base sm:w-60 sm:h-14 rounded mt-10 sm:my-10 mx-auto text-center p-[15px] sm:p-[18px] hover:cursor-pointer `}
        >
        ...
        <div
          className={` border-b border-y-gray-300   pt-8 sm:pt-5 mx-4 sm:mx-0`}
        ></div>
      </div>
    </div>
  );
